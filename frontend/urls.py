...
urlpatterns =patterns('frontend.views',
                      ...
                      url(r'^signup_and_class_code/$', 'signup_and_class_code', name="signup_and_class_code"),
                      ...
                      url(r'^classes/(?P<classgroup>[0-9A-Za-z]+)/grade_download_link/$', 'get_grade_download_link', name="get_grade_download_link"),
