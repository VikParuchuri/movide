...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClassSettings.enable_posting'
        db.add_column(u'api_classsettings', 'enable_posting',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ClassSettings.enable_posting'
        db.delete_column(u'api_classsettings', 'enable_posting')
