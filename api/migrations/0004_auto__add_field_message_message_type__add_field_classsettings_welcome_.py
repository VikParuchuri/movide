...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'api_message', 'message_type',
                      self.gf('django.db.models.fields.CharField')(default='D', max_length=3),
                      keep_default=False)

        # Adding field 'ClassSettings.welcome_message'
        db.add_column(u'api_classsettings', 'welcome_message',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'api_message', 'message_type')

        # Deleting field 'ClassSettings.welcome_message'
        db.delete_column(u'api_classsettings', 'welcome_message')
