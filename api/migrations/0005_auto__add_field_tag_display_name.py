...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tag.display_name'
        db.add_column(u'api_tag', 'display_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=160),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tag.display_name'
        db.delete_column(u'api_tag', 'display_name')
    ...
    models = {
        ...
        u'api.tag': {
            ...
            'display_name': ('django.db.models.fields.CharField', [], {'max_length': '160'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
