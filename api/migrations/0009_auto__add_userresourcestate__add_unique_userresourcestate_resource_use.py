...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'api_resource', ['name'])

        # Adding model 'UserResourceState'
        db.create_table(u'api_userresourcestate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('resource', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_resource_states', to=orm['api.Resource'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_resource_states', to=orm['auth.User'])),
            ('data', self.gf('django.db.models.fields.TextField')()),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'api', ['UserResourceState'])

        # Adding unique constraint on 'UserResourceState', fields ['resource', 'user']
        db.create_unique(u'api_userresourcestate', ['resource_id', 'user_id'])


        # Changing field 'Resource.display_name'
        db.alter_column(u'api_resource', 'display_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'UserResourceState', fields ['resource', 'user']
        db.delete_unique(u'api_userresourcestate', ['resource_id', 'user_id'])

        # Deleting model 'UserResourceState'
        db.delete_table(u'api_userresourcestate')


        # Changing field 'Resource.display_name'
        db.alter_column(u'api_resource', 'display_name', self.gf('django.db.models.fields.CharField')(default='Temp', max_length=50))
        # Adding unique constraint on 'Resource', fields ['name']
        db.create_unique(u'api_resource', ['name'])
    ...
    models = {
        ...
        u'api.rating': {
            'Meta': {'unique_together': "(('message', 'owner'),)", 'object_name': 'Rating'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
