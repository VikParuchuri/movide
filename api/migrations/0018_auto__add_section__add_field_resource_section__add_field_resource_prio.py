...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'api_section', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('display_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('classgroup', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sections', to=orm['api.Classgroup'])),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('_order', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'api', ['Section'])

        # Adding field 'Resource.section'
        db.add_column(u'api_resource', 'section',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='resources', null=True, to=orm['api.Section']),
                      keep_default=False)

        # Adding field 'Resource.priority'
        db.add_column(u'api_resource', 'priority',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'api_section')

        # Deleting field 'Resource.section'
        db.delete_column(u'api_resource', 'section_id')

        # Deleting field 'Resource.priority'
        db.delete_column(u'api_resource', 'priority')
    ...
    models = {
        ...
        u'api.resource': {
            ...
            'section': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'resources'", 'null': 'True', 'to': u"orm['api.Section']"}),
            'skills': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'resources'", 'to': u"orm['api.Skill']", 'through': u"orm['api.SkillResource']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
        ...
        u'api.section': {
            ...
            '_order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'classgroup': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sections'", 'to': u"orm['api.Classgroup']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'display_name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
        ...
        u'api.skillresource': {
            'Meta': {'unique_together': "(('skill', 'resource'),)", 'object_name': 'SkillResource'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'priority': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'resource': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['api.Resource']"}),
            'skill': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['api.Skill']"})
        },
