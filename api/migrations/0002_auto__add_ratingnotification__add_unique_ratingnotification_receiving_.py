...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RatingNotification'
        db.create_table(u'api_ratingnotification', (
            ...
            ('receiving_message', self.gf('django.db.models.fields.related.ForeignKey')(related_name='received_rating_notifications', to=orm['api.Message'])),
            ('receiving_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rating_notifications', to=orm['auth.User'])),
            ('origin_rating', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Rating'])),
        ))
        db.send_create_signal(u'api', ['RatingNotification'])

        # Adding unique constraint on 'RatingNotification', fields ['receiving_message', 'origin_rating']
        db.create_unique(u'api_ratingnotification', ['receiving_message_id', 'origin_rating_id'])

        # Adding model 'MessageNotification'
        db.create_table(u'api_messagenotification', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cleared', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('notification_type', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('receiving_message', self.gf('django.db.models.fields.related.ForeignKey')(related_name='received_message_notifications', to=orm['api.Message'])),
            ('receiving_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='message_notifications', to=orm['auth.User'])),
            ('origin_message', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Message'])),
        ))
        db.send_create_signal(u'api', ['MessageNotification'])

        # Adding unique constraint on 'MessageNotification', fields ['receiving_message', 'origin_message']
        db.create_unique(u'api_messagenotification', ['receiving_message_id', 'origin_message_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'MessageNotification', fields ['receiving_message', 'origin_message']
        db.delete_unique(u'api_messagenotification', ['receiving_message_id', 'origin_message_id'])

        # Removing unique constraint on 'RatingNotification', fields ['receiving_message', 'origin_rating']
        db.delete_unique(u'api_ratingnotification', ['receiving_message_id', 'origin_rating_id'])

        # Deleting model 'RatingNotification'
        db.delete_table(u'api_ratingnotification')

        # Deleting model 'MessageNotification'
        db.delete_table(u'api_messagenotification')
