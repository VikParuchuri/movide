...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Resource.section'
        db.alter_column(u'api_resource', 'section_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['api.Section']))

    def backwards(self, orm):

        # Changing field 'Resource.section'
        db.alter_column(u'api_resource', 'section_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['api.Section']))
    ...
    models = {
        ...
        u'api.resource': {
            ...
            'section': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'resources'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['api.Section']"}),
