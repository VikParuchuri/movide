...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'api_tag', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'Tweet.retweet_of'
        db.alter_column(u'api_tweet', 'retweet_of_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['api.Tweet']))

        # Changing field 'Tweet.reply_to'
        db.alter_column(u'api_tweet', 'reply_to_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['api.Tweet']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Tweet.retweet_of'
        db.alter_column(u'api_tweet', 'retweet_of_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['api.Tweet']))

        # Changing field 'Tweet.reply_to'
        db.alter_column(u'api_tweet', 'reply_to_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['api.Tweet']))
    ...
    models = {
        u'api.tag': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'created_tags'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
        ...
        u'api.tweet': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'reply_to': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'replies'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['api.Tweet']"}),
            'retweet_of': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'retweets'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['api.Tweet']"}),
