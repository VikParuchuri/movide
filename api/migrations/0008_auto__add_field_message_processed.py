...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.processed'
        db.add_column(u'api_message', 'processed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding M2M table for field mentions on 'Message'
        m2m_table_name = db.shorten_name(u'api_message_mentions')
    ...
    def backwards(self, orm):
        # Deleting field 'Message.processed'
        db.delete_column(u'api_message', 'processed')

        # Removing M2M table for field mentions on 'Message'
        db.delete_table(db.shorten_name(u'api_message_mentions'))
