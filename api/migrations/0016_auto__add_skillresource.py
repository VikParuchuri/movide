...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SkillResource'
        db.create_table(u'api_skillresource', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('skill', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Skill'])),
            ('resource', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Resource'])),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('priority', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'api', ['SkillResource'])
    ...
    def backwards(self, orm):
        # Deleting model 'SkillResource'
        db.delete_table(u'api_skillresource')
    ...
    models = {
        ...
        u'api.skillresource': {
            'Meta': {'object_name': 'SkillResource'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
