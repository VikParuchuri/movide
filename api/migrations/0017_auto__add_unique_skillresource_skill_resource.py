...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'SkillResource', fields ['skill', 'resource']
        db.create_unique(u'api_skillresource', ['skill_id', 'resource_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SkillResource', fields ['skill', 'resource']
        db.delete_unique(u'api_skillresource', ['skill_id', 'resource_id'])
