...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'api_skill', (
            ...
            ('classgroup', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='skills', null=True, on_delete=models.SET_NULL, to=orm['api.Classgroup'])),
            ...
            ('grading_policy', self.gf('django.db.models.fields.CharField')(default='COM', max_length=3)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'api', ['Skill'])

        # Adding unique constraint on 'Skill', fields ['classgroup', 'name']
        db.create_unique(u'api_skill', ['classgroup_id', 'name'])

        # Adding field 'Resource.parent'
        db.add_column(u'api_resource', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, on_delete=models.SET_NULL, to=orm['api.Resource']),
                      keep_default=False)

        # Adding M2M table for field skills on 'Resource'
        m2m_table_name = db.shorten_name(u'api_resource_skills')
        ...
        db.create_unique(m2m_table_name, ['resource_id', 'skill_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Skill', fields ['classgroup', 'name']
        db.delete_unique(u'api_skill', ['classgroup_id', 'name'])

        # Deleting model 'Skill'
        db.delete_table(u'api_skill')

        # Deleting field 'Resource.parent'
        db.delete_column(u'api_resource', 'parent_id')

        # Removing M2M table for field skills on 'Resource'
        db.delete_table(db.shorten_name(u'api_resource_skills'))
