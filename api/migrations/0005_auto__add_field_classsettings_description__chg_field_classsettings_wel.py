...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClassSettings.description'
        db.add_column(u'api_classsettings', 'description',
                      self.gf('django.db.models.fields.TextField')(default='This is a sample class description.  Please edit it in the settings view.'),
                      keep_default=False)


        # Changing field 'ClassSettings.welcome_message'
        db.alter_column(u'api_classsettings', 'welcome_message', self.gf('django.db.models.fields.TextField')())
        # Deleting field 'Classgroup.description'
        db.delete_column(u'api_classgroup', 'description')


    def backwards(self, orm):
        # Deleting field 'ClassSettings.description'
        db.delete_column(u'api_classsettings', 'description')


        # Changing field 'ClassSettings.welcome_message'
        db.alter_column(u'api_classsettings', 'welcome_message', self.gf('django.db.models.fields.TextField')(null=True))
        # Adding field 'Classgroup.description'
        db.add_column(u'api_classgroup', 'description',
    ...
    models = {
        ...
        u'api.classsettings': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'default': "'This is a sample class description.  Please edit it in the settings view.'"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_public': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'moderate_posts': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'welcome_message': ('django.db.models.fields.TextField', [], {'default': "'Welcome to your course!  Please edit this message in the settings view.'"})
        },
